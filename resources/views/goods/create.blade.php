...
@csrf
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="firstname"
                   placeholder="请输入商品名称" name="g_name">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" id="lastname"
                   placeholder="请输入商品货号" name="g_number">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" name="g_inventory" placeholder="请输入库存"/>
    ...
    <label for="lastname" class="col-sm-2 control-label">是否是精品</label>
            ...
            <div class="checkbox">
                <label>
                    是&nbsp;&nbsp;<input type="radio" name="is_jing" value="1" />
                    否&nbsp;&nbsp;<input type="radio" name="is_jing" value="2" checked />
                </label>
            </div>
    ...
    <label for="lastname" class="col-sm-2 control-label">是否是热卖</label>
            ...
            <div class="checkbox">
                <label>
                    ...
                    否&nbsp;&nbsp;<input type="radio" name="is_hot" value="2" checked />
                </label>
            </div>
