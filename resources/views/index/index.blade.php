  ...
  @section('content')
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/proinfo/'.$v->g_id)}}"><img src="{{env('UPLOAD_URL')}}{{$v->g_img}}" width='230' height='170'></a></dt>
        <dd class="ip-text"><a href="{{url('/proinfo/'.$v->g_id)}}">{{$v->g_name}}</a><span>已售：488</span></dd>
        <dd class="ip-price"><strong>¥299</strong> <span>{{$v->g_price}}</span></dd>
       </dl>
      </div>
      @endforeach
